                                        ...
                                        if (consoleMessage.messageLevel.toNativeValue() == 1) {
                                         ...
                                         _warehouseInteractionBloc.add(SelectedObject(dataFromJS: message, clearSearchText: clearSearchText));
                                          ...
                                          if(message.containsKey("openPathDialog") && message['openPathDialog'] == "true"){
                                            ...
                                            Customs.AnimatedDialog(context: context, header:   IconButton(icon:const Icon(Icons.local_activity_rounded,),onPressed: (){
                                            ...
                                            onClose: (){
                                             ...
                                             content: [
                                              ...
                                              TypeAheadField(
                                                ...
                                                return ListTile(title: Text(value.toString(), style: const TextStyle(fontSize: 14),),);
                                              }, 
