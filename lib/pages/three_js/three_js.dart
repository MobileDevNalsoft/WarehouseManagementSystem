        ...
        children: [
          BlocConsumer<WarehouseInteractionBloc, WarehouseInteractionState>(
              listener: (context, state) {
                if(state.isRendered!=null && state.isRendered!=false && context.read<WorkQueueBloc>().state.workQueueShownInitially!=null && !context.read<WorkQueueBloc>().state.workQueueShownInitially!){

     context.read<WorkQueueBloc>().add(GetWorkQueueData());
      ...
      context.read<WorkQueueBloc>().state.workQueueShownInitially=true;
                  ...
                  children: [
                    ...
                    Stack(
                      ...
                      children: [
                        ...
                        if (context.watch<WarehouseInteractionBloc>().state.isRendered!=null  && !context.watch<WarehouseInteractionBloc>().state.isRendered! && accessTypes.contains('Warehouse'))
                          Align(
                            alignment: Alignment.bottomCenter,
                            child: Container(
                              height: size.height * 0.92,
          ...
          AnimatedBuilder(
              ...
              if(context.watch<WarehouseInteractionBloc>().state.isRendered!=null && context.watch<WarehouseInteractionBloc>().state.isRendered==true)
          Positioned(
              left: 0,
              bottom: 16,
              child: PointerInterceptor(
                  child: Container(
                    ...
                    decoration:
                        BoxDecoration(borderRadius: BorderRadius.only(topRight: Radius.circular(16), bottomRight: Radius.circular(16)), color: Color.fromRGBO(68, 98, 136, 1)),
                    child: IconButton(
                        onPressed: () {
                          context.read<WorkQueueBloc>().add(GetWorkQueueData());
                          Customs.PendigDialog(context: context);
