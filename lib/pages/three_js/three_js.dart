              ...
              children: [
                ...
                Stack(
                  ...
                  children: [
                    ...
                    if (context.watch<WarehouseInteractionBloc>().state.isRendered != null &&
                        !context.watch<WarehouseInteractionBloc>().state.isRendered! &&
                        accessTypes.contains('Warehouse'))
                      Align(
                        alignment: Alignment.bottomCenter,
                        child: Container(
            ...
            Positioned(
                ...
                child: PointerInterceptor(
                  ...
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.only(topRight: Radius.circular(16), bottomRight: Radius.circular(16)), color: Color.fromRGBO(68, 98, 136, 1)),
                  child: IconButton(
                      onPressed: () {
                        context.read<WorkQueueBloc>().add(GetWorkQueueData());
                        Customs.PendigDialog(context: context);
