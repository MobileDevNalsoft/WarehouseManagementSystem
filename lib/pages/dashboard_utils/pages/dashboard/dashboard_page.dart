        ...
        children: [
          Row(
            children: [
              Gap(size.width * 0.1),
              SfCircularChart(
                  title: const ChartTitle(text: 'Trucks Info'),
              ...
              SfCartesianChart(
                  title: const ChartTitle(text: 'Daywise In Bound and Out Bound'),
          ...
          Row(
            children: [
              Gap(size.width * 0.1),
              SfCartesianChart(
                  title: const ChartTitle(text: 'Daywise Vehicle Engagement'),
                  primaryXAxis: const CategoryAxis(
                    labelStyle: TextStyle(color: Colors.black, fontSize: 16),
                    majorGridLines: MajorGridLines(
                      width: 0,
              ...
              Gap(size.width * 0.1),
              SfCircularChart(
                  title: const ChartTitle(text: 'In Bound vs Out Bound'),
                  tooltipBehavior: TooltipBehavior(
                    enable: true,
                  ),
                  legend: const Legend(
