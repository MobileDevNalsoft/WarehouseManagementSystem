                                                      ...
                                                      Expanded(
                                                        ...
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (context, index) => Container(
                                                              ...
                                                              child: Text(
                                                                isEnabled ? 'LOCATION' : state.warehouseUtilization!.available![index],
                                                                textAlign: TextAlign.center,
                                                              )),
                                                        ),
                                                      ),
                                                      Expanded(
                                                        ...
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (context, index) => Container(
                                                              height: size.height * 0.045,
                                                              width: size.width * 0.15,
                                                              child: Text(isEnabled ? 'LOCATION' : state.warehouseUtilization!.occupied![index],
                                                                  textAlign: TextAlign.center)),
                                                        ),
                                                      ),
                                                    ],
                                                      ...
                                                      Expanded(
                                                        ...
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (context, index) => Container(
                                                              ...
                                                              width: size.width * 0.15,
                                                              child: Text(
                                                                isEnabled ? 'ITEM' : state.inventorySummary!.inStock![index],
                                                                textAlign: TextAlign.center,
                                                              )),
                                                        ),
                                                      ),
                                                      Expanded(
                                                        ...
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (context, index) => Container(
                                                              height: size.height * 0.045,
                                                              width: size.width * 0.15,
                                                              child: Text(isEnabled ? 'ITEM' : state.inventorySummary!.runningOutOfStock![index],
                                                                  textAlign: TextAlign.center)),
                                                        ),
                                                      ),
                                                      Expanded(
                                                        ...
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (context, index) => Container(
                                                              height: size.height * 0.045,
                                                              width: size.width * 0.15,
                                                              child: Text(isEnabled ? 'ITEM' : state.inventorySummary!.outOfStock![index],
                                                                  textAlign: TextAlign.center)),
                                                        ),
                                                      ),
                                                    ],
