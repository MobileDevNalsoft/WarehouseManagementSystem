...
class _MapsState extends State<Maps> with TickerProviderStateMixin {
   StreamController<List<Marker>> _mapMarkerSC = StreamController<List<Marker>>.broadcast();
    ...
    return StreamBuilder<List<Marker>>(
      ...
      builder: (context, snapshot) {
        return GoogleMap(
          ...
          markers: context.watch<TripsBloc>().state.markers.toSet(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<TripsBloc, TripsState>(
        ...
        //   print("map status ${state.mapStatus}");
        //   if(state.mapStatus==MapStatus.loadMap ){
        //     state.mapStatus=MapStatus.loadingDone;
        //     _mapMarkerSC.close();
        //     Future.delayed(Duration(seconds: 1),()=>{
        //       _mapMarkerSC = StreamController<List<Marker>>(),
             
        //       // context.read<TripsBloc>().add(AnimateDriver(mapMarkerSC: _mapMarkerSC, provider: this, context: context))
        //       });
           
        //   }
        // } ,
        // buildWhen: (previous, current) => current.mapStatus==MapStatus.loadingDone,
