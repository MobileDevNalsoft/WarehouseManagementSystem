...
class _BinDataSheetState extends State<BinDataSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Customs.DataSheet(context: context, size: size, title: _warehouseInteractionBloc.state.dataFromJS['bin'].toString() == "" ? 'Storage Area' : 'Storage Bin', children: [
              ...
              return ClipRRect(
                ...
                child: (state.storageBinStatus == StorageBinStatus.success && state.storageBinItems!.isEmpty)
                    ? Column(
                        children: [
                          Text(
                            _warehouseInteractionBloc.state.dataFromJS['bin'] != ""
                                ? _warehouseInteractionBloc.state.dataFromJS['bin']
                    ...
                    : ListView.builder(
                                        ...
                                        children: [
                                          if (state.storageBinItems![index].image != null && state.storageBinItems![index].image != '')
                                            Container(
                                              ...
                                              child: ClipRRect(
                                                ...
                                                child: Image.memory(
                                                  base64Decode((state.storageBinItems![index].image!.contains("data:image"))
                                                      ? state.storageBinItems![index].image!.substring(22)
                                                      : state.storageBinItems![index].image!),
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                            ),
                                          SizedBox(
                                              ...
                                              child: SingleChildScrollView(
                                                  ...
                                                  child: Text(
                                                    state.storageBinItems![index].itemKey ?? "item",
                                                    style: TextStyle(
                                                        fontSize: containerSize.maxWidth * 0.044,
                                                        // height: containerSize.maxHeight * 0.004,
                                          ...
                                          if (_warehouseInteractionBloc.state.dataFromJS.containsKey('bin') && _warehouseInteractionBloc.state.searchText != "")
                                            Transform.rotate(
                                              ...
                                              child: IconButton(
                                                ...
                                                icon: Icon(
                                                  Icons.bookmark,
                                                  size: containerSize.maxWidth * 0.08,
                                                ),
                                              ),
                                            ),
                                        ],
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Image.asset(
                                              ...
                                              width: containerSize.maxWidth * 0.1,
                                            ),
                                          ),
                                          Text(
                                            state.storageBinItems![index].rcvdShipmentKey ?? "asn1",
                                            style: TextStyle(
                                              fontSize: containerSize.maxWidth * 0.044,
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Image.asset(
                                              ...
                                              height: containerSize.maxHeight * 0.08,
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Padding(
                                            padding: EdgeInsets.only(left: containerSize.maxWidth * 0.006, right: containerSize.maxWidth * 0.032),
                                            child: Image.asset(
                                              'assets/images/serial_no.png',
                                              height: containerSize.maxHeight * 0.16,
                                              width: containerSize.maxWidth * 0.1,
                                            ),
                                          ),
                                          SizedBox(
                                              ...
                                              child: SingleChildScrollView(
                                                  scrollDirection: Axis.horizontal,
                                                  child: Text(
                                                    state.storageBinItems![index].containerNbr!,
                                                    style:
                                        ...
                                        children: [
                                          Padding(
                                            ...
                                            child: Image.asset(
                                              ...
                                              width: containerSize.maxWidth * 0.09,
                                            ),
                                          ),
                                          Text(
                                            state.storageBinItems![index].currQty ?? "1",
                                            style: TextStyle(
                                              fontSize: containerSize.maxWidth * 0.044,
                                              height: containerSize.maxHeight * 0.0016,
                                              fontWeight: FontWeight.bold,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          SizedBox(
                                              width: containerSize.maxWidth * 0.3,
                                              child: SingleChildScrollView(
                                                  scrollDirection: Axis.horizontal,
                                                  child: Skeletonizer(
                                                      enableSwitchAnimation: true,
                                                      child: Text(
                                                        "----------",
                                                        style: TextStyle(
                                                            fontSize: containerSize.maxWidth * 0.044, height: containerSize.maxHeight * 0.0016, fontWeight: FontWeight.bold),
                                                      )))),
                                        ],
                                      ),
                                      Row(
                                          ...
                                          SizedBox(
                                              ...
                                              child: Skeletonizer(
                                                  ...
                                                  child: Text(
                                                    "----------",
                                                    style:
                                                        TextStyle(fontSize: containerSize.maxWidth * 0.044, height: containerSize.maxHeight * 0.0016, fontWeight: FontWeight.bold),
                                                  ))),
                                        ],
                                      ),
                                    ],
                        ...
                        itemCount: isEnabled
                            ? 8
                            : state.storageBinItems!.length + 1 > (state.pageNum! + 1) * 100
                                ? state.storageBinItems!.length + 1
                                : state.storageBinItems!.length),
              );
            }),
          );
        },
