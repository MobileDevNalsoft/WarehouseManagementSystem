...
class _BinDataSheetState extends State<BinDataSheet> {
  ...
  void _scrollListener() async {
    if (_controller.position.pixels == _controller.position.maxScrollExtent &&
        _storageBloc.state.storageBinItems!.length + 1 > (_storageBloc.state.pageNum! + 1) * 100) {
  ...
  Widget build(BuildContext context) {
    ...
    return Customs.DataSheet(
        context: context,
        size: size,
        title: _warehouseInteractionBloc.state.dataFromJS['bin'].toString() == "" ? 'Storage Area' : 'Storage Bin',
        children: [
                                                  ...
                                                  child: IconButton(
                                                    onPressed: () {
                                                      ...
                                                      getIt<JsInteropService>()
                                                          .navigateToBin(state.storageBinItems![index].locationKey.toString().replaceAll('-', '').substring(2));
                                                      _warehouseInteractionBloc.state.inAppWebViewController!.webStorage.localStorage
                                                          .setItem(key: "rack_cam", value: "storageArea");
                                                      // }
                                                    },
                                                    icon: Icon(
                                                      Icons.bookmark,
                                            ...
                                            children: [
                                              ...
                                              SizedBox(
                                                  ...
                                                  child: SingleChildScrollView(
                                                      scrollDirection: Axis.horizontal,
                                                      child: Text(
                                                        state.storageBinItems![index].serialNbrKey!,
                                                        style: TextStyle(
                                                            fontSize: containerSize.maxWidth * 0.044,
                                                            height: containerSize.maxHeight * 0.004,
                                                            fontWeight: FontWeight.bold),
