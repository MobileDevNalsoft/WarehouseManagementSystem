...
class _QualityCheckState extends State<QualityCheck> {
  ...
  void initState() {
    ...
    _workflowBloc.add(GetQualityCheckTasks(facilityID: 243));
            ...
            child: Stack(
              children: [
                          ...
                          label: Container(
                              ...
                              child: BlocBuilder<WorkflowBloc, WorkflowState>(
                                ...
                                return Checkbox(
                                    ...
                                    onChanged: (value) {
                                      context.read<WorkflowBloc>().add(QualityCheckStatusUpdated(lpnNbr: state.qualityCheckTasks.map((e) => e.lpnNbr!).toList(), isChecked: value!));
                                    });
                              }))),
                    GridColumn(
                        columnName: 'Facility',
                ...
                if (state.postQualityCheckStatus == PostQualityCheckStatus.loading)
                  Center(
                    child: Container(            
                        child: Customs.DashboardLoader(lsize: BoxConstraints(maxWidth: size.width * 0.5, maxHeight: size.height * 0.5))),
                  )
              ],
            ),
          ))
