                      ...
                      children: widget.dropDownItems.map((item) {
                        return InkWell(
                          onTap: () {
                            ...
                            setState(() {
                              height =
                                  height == dropDownHeight! + (widget.buttonHeight + 5) ? widget.buttonHeight : dropDownHeight! + (widget.buttonHeight + 5);
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            widget.dropDownType,
                            style: TextStyle(
                              fontSize: widget.buttonWidth * 0.064,
                              color: Colors.white,
                            ),
                          ),
                          AnimatedRotation(
