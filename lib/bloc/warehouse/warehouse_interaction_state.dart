...
final class WarehouseInteractionState{
  WarehouseInteractionState({required this.dataFromJS, this.inAppWebViewController, this.isModelLoaded = false, this.intercepting = true, this.isRendered = true, this.selectedSearchArea = "Storagearea", this.searchText,this.getState = GetCompanyDataState.initial,
  ...
  factory WarehouseInteractionState.initial() {
    return WarehouseInteractionState(dataFromJS: {"object": "null"}, isModelLoaded: false, intercepting: false,getState: GetCompanyDataState.initial,facilityDataState: GetFacilityDataState.initial,companyModel: CompanyModel(results: [CompanyResults(name: "M10 Company", id: 1),CompanyResults(name: "Demo", id: 2),CompanyResults(name: "Demo Customer1", id: 3),CompanyResults(name: "Demo Customer2"),CompanyResults(name: "SUM Compnay", id: 4),CompanyResults(name: "VIM Company", id: 5)],),selectedCompanyVal: "M10 Company"
