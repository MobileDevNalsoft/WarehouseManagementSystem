...
final class StorageState {
  ...
  StorageState copyWith({StorageAisle? storageArea,StorageAreaStatus? storageAreaStatus,List<StorageBinItem>? storageBinItems,StorageBinStatus? storageBinStatus, int? pageNum,ListOfStorageAisles? storageAisles }){
    return StorageState(storageArea: storageArea??this.storageArea,storageAreaStatus:storageAreaStatus??this.storageAreaStatus,storageBinItems: storageBinItems??this.storageBinItems,storageBinStatus: storageBinStatus??this.storageBinStatus, pageNum: pageNum ?? this.pageNum,storageAisles:storageAisles??this.storageAisles);
  }
